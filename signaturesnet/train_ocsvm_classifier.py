...
from signaturesnet.trainers.oc_svm_trainer import train_ocsvm_classifier
from signaturesnet.utilities.io import update_dict, read_config, write_result

from signaturesnet import TRAINING_CONFIGS


DEFAULT_CONFIG_FILE = [os.path.join(TRAINING_CONFIGS, "ocsvm_classifier/config.yaml")]
...
if __name__ == "__main__":
    ...
    min_val = train_ocsvm_classifier(config=config)
